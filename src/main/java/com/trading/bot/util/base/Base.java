package com.trading.bot.util.base;

import com.trading.bot.util.mapper.TickerMapper;
import org.mapstruct.factory.Mappers;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.trading.bot.util.mapper.CurrencyMapper;
...
//    protected static final UtilMapper UTIL_MAPPER = Mappers.getMapper(UtilMapper.class);
    ...
    /** Currency mapper. */
    public static final CurrencyMapper CURRENCY_MAPPER = Mappers.getMapper(CurrencyMapper.class);
...
//    protected static final CandleMapper CANDLE_MAPPER = Mappers.getMapper(CandleMapper.class);
    ...
    /** Ticker mapper. */
    public static final TickerMapper TICKER_MAPPER = Mappers.getMapper(TickerMapper.class);
