...
import com.trading.bot.util.base.configuration.BaseConfiguration;
 ...
 */
@Configuration
@EntityScan(basePackages = "com.trading.bot.domain")
@EnableJpaAuditing(dateTimeProviderRef = "auditingDateTimeProvider")
@EnableJpaRepositories(basePackages = "com.trading.bot.repository")
